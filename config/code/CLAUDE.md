...
- **MCP Gateway:** `https://mcp.epiphanyco.com/mcp` — 34 modules, 300+ tools. Source on Unraid.
...
- **Preferences** (`pref_call`): User preferences and work patterns.
...
2. Individual calls only for deeper drill-down
